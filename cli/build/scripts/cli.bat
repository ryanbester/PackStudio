...
set CLASSPATH=%APP_HOME%\lib\cli-1.0-SNAPSHOT.jar;%APP_HOME%\lib\lib-1.0-SNAPSHOT.jar;%APP_HOME%\lib\api-1.0-SNAPSHOT.jar;%APP_HOME%\lib\gson-2.8.6.jar


@rem Execute cli
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %CLI_OPTS%  -classpath "%CLASSPATH%" com.ryanbester.packstudio.cli.Main %*
